...
class PyIDE:
    ...
    def SyntaxHighlighting(self):
        ...
        self.colorMap = {"print": "light sky blue", "def": "gold", "import": "orange", "from": "orange",
                         ...
                         "\\n": "green2", "\\r": "green2", "class": "orange2", "None": "brown3","input":"dark blue",}
    ...
    def PackageWindow(self):
        ...
        self.output.insert("end-1c",
                           "Your output will be shown here\n1.Write your code\n2.Save it\n3.Run\nActually this area is in construction")
    ...
    def AboutUs(self):
        messagebox.showinfo("About",
                            "The project is the work of karim khelifa and belbahi ilyes")
    ...
    def __UpdateTitle(self):
        #changes the title to the current filename
